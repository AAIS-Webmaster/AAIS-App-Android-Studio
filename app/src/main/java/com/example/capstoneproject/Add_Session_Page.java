...
public class Add_Session_Page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()) {
                    ...
                    try {
                        ...
                        sessions.add(new Session(track_selected, name, localDate, startTime, endTime,
        ...
        addStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Add_Session_Page.this, style, onTimeSetListener, hour, minute, true);
